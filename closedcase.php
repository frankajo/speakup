 ...
 ?>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">
      <small>Case Handled and Closed</small>
    </h1>
          ...
          <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="closed.php?complaintid=<?php echo $complaintid ?>&firstname=<?php echo $value['firstname']; ?>&lastname=<?php echo $value['lastname']; ?>&complaintstatus=<?php echo $value['complaint_status']; ?>" class="btn btn-primary" id="btnclosed">status</a> 
